...
const Footer = () => {
  // Responsive
  const { isMobileSmall: MobileS, isDesktop: Desktop, isTablet: Tablet, isMobile: Mobile } = useResponsive();
  const wrapClass = clsx({
    "grid grid-cols-[1fr_1fr_1.5fr] justify-between 2xl:grid-cols-[1fr_1fr_1fr] 2xl:px-[200px] xl:px-[195px] px-[100px] gap-5":
      Desktop,
    "w-[690px] flex flex-col gap-[30px] px-[60px]": Tablet,
    "w-[315px] flex flex-col gap-[30px] m-auto": Mobile,
    "w-[250px] flex flex-col gap-[30px] mx-5": MobileS,
  });
    ...
    <footer className="py-10 bg-bg-secondary ">
      <div className={wrapClass}>
        ...
        <div>
          ...
          {Desktop && (
            <div className="bg-white rounded-[20px] 2xl:w-[500px] flex justify-between gap-5">
              <div>
                <Inputs
                  id="email"
                  name="email"
